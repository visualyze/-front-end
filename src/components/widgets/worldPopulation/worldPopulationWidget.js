...
// Note: the chart is set up, but for the purposes of this project it was too large for the widget cards. It will likely need a different data representation chart
...
import './worldPopulationWidget.scss';
...
class WorldPopulation extends Widget {
  constructor(props) {
    super(props);
  ...
  renderWidget() {
    ...
    if (this.state.isLoading) {
      this.handleRefresh();
      return <div className="WorldPopulation">Loading...</div>;
    }
    if (this.state.isResizing) {
      return <div className="WorldPopulation">(Resizing in progress)</div>;
    }

    return (
      <div className="WorldPopulation">
